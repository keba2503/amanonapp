                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6">
                            <div className="single-footer-widget">
                                ...
                                <ul className="social">
                                    ...
                                    <li>
                                        <a href="https://www.instagram.com/amanon.pe/" target="_blank">
                    ...
                    <div className="container">
                        <div className="row align-items-center">
                            <div className="col-lg-6 col-md-6 col-sm-6">
                                <p>Copyright &copy;{currentYear} amanon. All Rights Reserved <a href="https://envytheme.com/" target="_blank">EnvyTheme</a>.</p>
                            </div>
